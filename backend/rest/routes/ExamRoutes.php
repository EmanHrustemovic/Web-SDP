...
Flight::route('GET /customers', function(){
    ...
    */
    ...
    $all_customers = Flight::examService()->get_customers();
    Flight::json($all_customers);
});
...
Flight::route('GET /customer/meals/@customer_id', function($customer_id){
    ...
    */
    ...
    $customers_meals = Flight::examService()->get_customer_meals($customer_id);
    Flight::json($customers_meals);
});
...
Flight::route('POST /customers/add', function() {
    ...
    */
    ...
    $new_customer = Flight::examService()->add_customer($data);
    Flight::json($new_customer);
...
Flight::route('GET /foods/report', function(){
    ...
    */
    ...
    $food_reports = Flight::examService()->foods_report();

    Flight::json($food_reports);
});
